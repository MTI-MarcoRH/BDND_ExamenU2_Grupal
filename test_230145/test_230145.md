...
- Muestra los registros que han realizado en la base de datos.
...
- Deberá contar con al menos 40 registros de categorización de productos (por aquello que les toco subcategorizar)
...
```md
![Test 01 - Consulta de Registros](./test_230145/captura.png)
