...
•Aplica filtros (*WHERE*) a la vista de **Registro por estudiante**
...
•Deberá contar al menos 40 registros de categorización de productos ( por aquellos que les toco una subcategoría)
•Deberá contar con 20 registros de categorización en base al origen del producto (Nacional / Importación)

###Evidencia
![Test 01 - Consulta de Registro](./tests_230094/test1_230094.png)
